{
  bemenu, dunst, firefox, franz, gnome-screenshot,
  ...
  i3Config = writeTextFile {
    ...
    text = ''
      ...
      set $menu ${bemenu}/bin/bemenu-run \
        --fn 'PragmataPro 26' -p "" --fb '#282828' --ff '#f9f5d7' --hb '#98971a' --hf '#f9f5d7' --nb '#282828' --nf '#f9f5d7' \
        --sf '#282828' --sb '#f9f5d7' --tf '#f9f5d7' --tb '#282828' | xargs swaymsg exec --
